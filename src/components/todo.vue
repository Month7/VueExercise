<template>
    <div class="main">
        ...
        />
        <ul class="task-count" v-show="items.length">
        ...
        <div class="tasks">
            <span class="no-task-tip" v-show="!items.length">还没有添加任何任务</span>
            <ul class="todo-list">
                <li class="todo" :class="{completed:item.isChecked}" v-for="item in items" :key="item.message">
                    <div class="view">
